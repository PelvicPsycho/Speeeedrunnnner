 ...
 */
UCLASS(ClassGroup = Movement, meta = (BlueprintSpawnableComponent), DisplayName = "Custom Floating Pawn Movement", MinimalAPI)
class UCustomFloatingPawnMovement : public UPawnMovementComponent
{
